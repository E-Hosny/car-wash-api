...
return [
    ...
    'minimum_booking_advance_minutes' => 'الحد الأدنى للوقت المتبقي قبل الحجز (بالدقائق)',
    'minimum_booking_advance_minutes_label' => 'الحد الأدنى للوقت المتبقي قبل الحجز (بالدقائق)',
    'minimum_booking_advance_minutes_help' => 'حدد الحد الأدنى للوقت (بالدقائق) الذي يجب أن يكون متبقيًا قبل أول ساعة متاحة. إذا كان الوقت المتبقي أقل من هذا الحد، سيتم إغلاق الساعة تلقائياً (مثال: 20 دقيقة)',
    'fully_booked' => 'محجوز بالكامل',
    'customer_details' => 'تفاصيل العميل',
    'back_to_users' => 'العودة للمستخدمين',
    'saved_cars' => 'سيارات العميل',
    'saved_addresses' => 'مواقع العميل المحفوظة',
    'customer_orders' => 'طلبات العميل',
    'no_cars' => 'لا توجد سيارات مسجلة',
    'no_addresses' => 'لا توجد مواقع محفوظة',
    'no_customer_orders' => 'لا توجد طلبات',
    'label' => 'التسمية',
    'notes' => 'ملاحظات',
