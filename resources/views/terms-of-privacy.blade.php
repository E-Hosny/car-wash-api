...
<head>
    ...
    <title>Terms of Privacy - Car Wash App</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li>Location data (when you request car wash services)</li>
            <li>Payment information (processed securely through third-party payment processors)</li>
            <li>Device information (device ID, operating system, app version)</li>
        </ul>

        <h3>1.2 Usage Information</h3>
        <p>We automatically collect certain information about your use of our app:</p>
        <ul>
        ...
        <ul>
            <li>Provide and maintain our car wash services</li>
        ...
        <ul>
            <li><strong>Service Providers:</strong> With trusted third-party service providers who assist us in operating our app and providing services</li>
        ...
        <p>Our app may request access to your device's location to:</p>
        <ul>
            <li>Provide accurate car wash service locations</li>
            <li>Calculate service areas and availability</li>
        ...
        <p>We may send push notifications to:</p>
        <ul>
            <li>Confirm your car wash appointments</li>
        ...
        <p>We retain your personal information for as long as necessary to provide our services and comply with legal obligations. You may request deletion of your account and associated data by contacting us.</p>
